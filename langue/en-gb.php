...
$vocab['activer_fonctionalite_participant'] = "Activate the \"Participant \" functionality when creating a reservation";
...
$vocab['admin_access_site'] = "Restricted access to sites";
...
$vocab['admin_admin_site'] = "Sites administration";
...
$vocab['admin_cgu'] = "ToU";
$vocab['admin_clean_accounts_desc'] = "The following action will clean up all the liaison tables for user accounts. It is a maintenance operation, normally unnecessary and without consequence on the operation of GRR. <b>As a precaution, back up your database before doing this</b>.";
$vocab['admin_config_calend1'] = "Calendar setup";
...
$vocab['admin_couleurs_explications'] = "On this page, you can define a number of colors that will modify the personal style.<br /> Further changes can be made by editing the style file personnalisation/css/perso.css <br />The initial colors reflect the default model.";
...
$vocab['admin_import_users_csv2'] = "<p>Imported file must be in CSV format (delimiter: semicolon, charset: UTF-8)<br />The file must contain the following fields:<br />--> <B>Login</B>: login-name<br />--> <B>Name</B><br />--> <B>First name</B><br />--> <B>Password</B><br />--> <B>Email address</B> (optional)<br />--> <B>User type: (\"visitor\", \"user\", \"administrator\")</B><br />--> <B>Status: (\"active\",\"inactive\")</B><br />--> <B>Authentification type: (\"local\", \"ext\")</B><br />--> <b>Password on next login: (\"0\" = no, (\"1\" = yes)</b><br />";
$vocab['admin_import_users_csv3'] = "<p><b>SOME PRECISIONS:</b><br /><br /><b>Login-name</b><br />Maximum of 40 characters. It can only contain letters, numbers and underscore (_). If this format is not followed, the following string ??? will appear instead of the login name. Existing accounts are displayed in red. Existing data will be replaced during importation!<br /><br /><b>Name</b><br />User's name. Maximum 30 characters. It can only contain letters, numbers, spaces and single quotes<br /><br /><b>First name</b><br />User's first name. Same restrictions as the name. First and last names that match an existing account will be displayed in blue.<br /><br /><b>Password</b><br />Leave empty if authentification type is \"ext\".".$pass_leng." characters minimum and 30 characters maximum.<br /><br /><b>Email address</b><br />100 characters maximum.<br /><br /><b>Authentification type</b><br />\"local\" in most cases and \"ext\" an external auth system such as LDAP, CAS, etc.<br /><br /></p>";
...
$vocab['admin_mails'] = "Email personalization";
...
$vocab['admin_purge_accounts_sauf_privileges'] = "Purge external without privileges";
...
$vocab['admin_purge_tables_liaison'] = "Links cleaning";
...
$vocab['admin_right_admin'] = "Areas management";
...
$vocab['admin_right'] = "Resources management";
...
$vocab['admin_type_explications'] = "This is the default type defined for all areas for each new type of reservation. This can then be modified for each area.";
$vocab['admin_type_modify_create'] = "Add a new reservation type";
$vocab['admin_type_modify_modify'] = "Change a reservation type";
$vocab['admin_type'] = "Reservations types";
$vocab['admin_user_demandes'] = "Requests";
$vocab['admin_user_mdp_facile_description'] = "These passwords are considered as too easy: id, azerty, an empty password, 123456, 12345678, 000000, 00000000. Yet some other passwords are easy: it is yours to advise the users."; 
$vocab['admin_user_mdp_facile'] = "Users with a password that is too simple";
$vocab['admin_user_modify_create'] = "Add a new user";
...
$vocab['allow_gestionnaire_modify_del1'] = "An administrator of a resource can delete or modify any reservation.";
...
$vocab['allow_search_level5'] = "You must be connected and have \"administrator\" to access the search tool.";
...
$vocab['any_area'] = "All domains";
$vocab['archiver'] = "Archive";
$vocab['areas'] = "Areas: ";
$vocab['attention_mail_automatique_desactive'] = "ATTENTION: Automatic email sending is currently disabled. <a href=\"admin.php?p=admin_config3\">Configure</a>";
$vocab['attention_mail_desactive'] = "ATTENTION: The mail sending server is currently disabled. <a href=\"admin.php?p=admin_config3\">Configure</a>";
...
$vocab['authentification_CAS'] = "Authenticate by CAS SSO";
...
$vocab['authentification_obli0'] = "It's not necessary to connect to see the reservations<br /><i>(but the connection is mandatory if the user wants to reserve or modify a reservation)</i>";
...
$vocab['avertissement_actions_irreverssibles'] = "WARNING: the actions performed on this page are irreversible!";
...
$vocab['back'] = "Back";
$vocab['bdd_informations'] = "DB Informations";
...
$vocab['booking_in_past_explain_with_periodicity'] = "One or more reservations pose a problem because they are in the past. <br />Please choose end of reservation dates that are later than the current date:";
...
$vocab['cacher_page_login'] = "You can set a link (https://...) below to prevent access to the login page by redirecting the unauthenticated user to this address:";
...
$vocab['calendrier_feries'] = "Public holiday calendar";
$vocab['calendrier_vacances'] = "Holiday calendar";
$vocab['cancel'] = "Cancel";
$vocab['capacity_2'] = "Capacity: ";
$vocab['capacity'] = "Maximum number of people allowed in the room (0 if it is not a room)";
$vocab['captcha_incorrect'] = "Wrong captcha!";
$vocab['captcha_utiliser'] = "Use captcha";
$vocab['cas_code_fonction'] = "Code of the function";
...
$vocab['choisir_image_ressource'] = "Choose an image of the resource for the presentation page (png, jpg and gif only)";
...
$vocab['config_cas_attributs'] = "CAS attributes to retrieve and map to GRR database fields (for the CAS service to be operational, it is also necessary to configure your CAS server).";
...
$vocab['courrier_msg'] = "Show room management by mail";
$vocab['courrier'] = "Courrier";
$vocab['crea_compte_inscrivez'] = "Register";
...
$vocab['del_group_succeed'] = "The group has been successfully deleted.";
...
$vocab['display_mail_etat_destinataire'] = "Contact form for reservation";
...
$vocab['display_type_order_identifiant'] = "Sort order by identifier";
$vocab['display_type_order_nom'] = "Sort order by name";
...
$vocab['mail_de'] = "From";
$vocab['mail_desc_admin_test'] = "Test email sent from the GRR administration panel.";
$vocab['mail_desc_compte_creation'] = "Email sent to the requester and to the user manager(s) when an account creation request is submitted.";
$vocab['mail_desc_compte_decision1'] = "Email sent to the beneficiary when the request is approved.";
$vocab['mail_desc_compte_decision2'] = "Email sent to the beneficiary when the request is rejected.";
$vocab['mail_desc_dest_adm'] = "Email sent to people notified via the administration panel and/or an additional field.";
$vocab['mail_desc_dest_beneficiaire'] = "Email sent to the reservation beneficiary.";
$vocab['mail_desc_dest_gestionnaire'] = "Email sent to the resource manager.";
$vocab['mail_desc_dest_supauto'] = "Automatic deletion email sent to the beneficiary and to people notified via the administration panel and/or an additional field.";
...
$vocab['mail_type_resa_sup'] = "Reservation deletion";
...
$vocab['modification_parametre_domaine'] = "Users authorized to modify their domain and resource by default";
$vocab['modification_parametre_email'] = "Users authorized to modify their e-mail address";
$vocab['modification_parametre_langue'] = "Users authorized to modify their language";
...
$vocab['msg_login1'] = "GRR is under GPL licence, adapted from <a href='http://mrbs.sourceforge.net'>MRBS</a>.<br />To obtain information about GRR: ";
...
$vocab['pass_leng_error'] = "Minimum password length too small according to criteria!";
$vocab['pass_leng_explain'] = "Minimal length of the password";
$vocab['pass_nb_ch'] = "Minimum number of digits";
$vocab['pass_nb_maj'] = "Minimum number of uppercase";
$vocab['pass_nb_min'] = "Minimum number of lowercase";
$vocab['pass_nb_sp'] = "Minimum number of special characters";
$vocab['pass_x_ch'] = "number";
$vocab['pass_x_chs'] = "numbers";
...
$vocab['pwd_toot_short'] = "Minimum (".$pass_leng." characters)";
$vocab['pwd'] = "Password";
...
$vocab['reservations_supprimes'] = "Reservations canceled";
...
$vocab['supprimer_tout'] = "Delete all";
...
$vocab['type_color_icone'] = "Choice of icon in hexadecimal";
...
$vocab['user_site_list'] = "List of the people authorized to access this site (apart from administrators):";
...
$vocab['utilisateurs_reservant'] = "The resource is limited. The following users can reserve this resource:";
