...
$vocab["accepter_resa_serie"] = "Accept the reservation and all reservations bound by periodicity which are not yet moderated.";
...
$vocab["activer_fonctionalite_participant"] = "Who can use the \"participant\" feature";
$vocab["activer_fonctionalite_ressource_empruntee_restituee"] = "Activate the \"borrowed / restored resource\" functionality";
$vocab["Activer_log_email"] = "Enable email logging";
...
$vocab["adm_cfg5_msg0"] = "Unable to find the installation or info file!";
$vocab["admin"] = "Management ";
$vocab["admin_access_area"] = "Access to restricted domains";
$vocab["admin_access_site"] = "Access to restricted sites";
$vocab["admin_accueil"] = "Dashboard";
$vocab["admin_admin_site"] = "Site administration";
...
$vocab["admin_backup_recommande"] = "We recommend backing up the database beforehand";
$vocab["admin_book_room"] = "Access to booking restricted resources";
$vocab["admin_calend"] = "Block reservation/deletion";
$vocab["admin_calend_ignore"] = "Calendar not available for booking";
...
$vocab["admin_calend_jour_cycle1"] = "Calendar of \"cycle days\"";
$vocab["admin_calend_vacances_feries"] = "School holidays and public holidays";
$vocab["admin_calendar_explain_1"] = "This procedure allows you to quickly reserve or release time slots simultaneously across multiple resources in several domains and according to a calendar. For example, you can block out certain days throughout the year, such as weekends, holidays, and public holidays. Warning: If there is a conflict with existing reservations, these will be automatically and permanently deleted in favor of the new reservation. Furthermore, those affected by the deletions will not be notified by email. This procedure takes place in three steps: 1. Selection of the domain(s) and the type of action; 2. Selection of the resources to reserve, name, description, and type of reservation; 3. Selection of the dates and times to reserve on a calendar. The actual changes to the reservations only occur after the third step.";
$vocab["admin_calendar_title"] = "Bulk Reservation/Deletion";
$vocab["admin_cgu"] = "T&C";
...
$vocab["admin_config7"] = "Features";
$vocab["admin_config_calend1"] = "Calendar Settings";
$vocab["admin_config_calend2"] = "Creating/Regenerating the \"Cycle Days\" Calendar";
$vocab["admin_config_calend3"] = "Modifying/Viewing the \"Cycle Days\" Calendar";
...
$vocab["admin_confirm_change_date_bookings"] = "Confirmation of change to the start and end dates of bookings";
$vocab["admin_corresp_statut"] = "SSO Matches";
...
$vocab["admin_log_resa_liste"] = "Reservation Logs";
$vocab['admin_mail_serveur'] = "Mail server";
$vocab["admin_mails"] = "Email Customization";
$vocab["admin_maj"] = "Version and Updates";
...
$vocab["admin_nettoyage_bdd"] = "Database Cleanup";
$vocab["admin_overload"] = "Additional Fields";
...
$vocab["admin_right"] = "Resource Management";
$vocab["admin_right_admin"] = "Domain Administration";
...
$vocab["admin_room"] = "Domains and resources";
...
$vocab["admin_type"] = "Booking types";
...
$vocab["admin_type_modify_create"] = "Adding a new booking type";
$vocab["admin_type_modify_modify"] = "Modifying a booking type";
...
$vocab["admin_user_demandes"] = "Requests";
...
$vocab["admin_view_connexions"] = "Monitoring connections";
$vocab["admin_view_emails"] = "Monitoring emails";
$vocab["administrateur_du_domaine"] = "Domain administrator";
$vocab["administrateur_du_site"] = "Site administrator";
...
$vocab["afficher_non"] = "Do not display";
$vocab["afficher_oui"] = "Display";
...
$vocab["Alphanumericeric"] = "Alphanumericeric value";
...
$vocab["auteur"] = "Author";
$vocab["authentification"] = "Authentication";
$vocab["authentification_base_externe"] = "External (SSO, LDAP, ...)";
$vocab["authentification_base_locale"] = "Local (GRR data base)";
$vocab["authentification_CAS"] = "Authenticate to the Central Authentication Service (SSO)";
$vocab["authentification_http"] = "Authenticate with HTTP";
$vocab["authentification_lasso"] = "Authenticate with Lasso ID provider";
$vocab["authentification_lcs"] = "Authenticate directly to your personal space LCS";
$vocab["authentification_lemon"] = "Authenticate with LemonLdap service";
...
$vocab["avertissement_actions_irreversibles"] = "WARNING: actions performed on this page are irreversible!";
...
$vocab["bdd_informations"] = "Database Information";
$vocab["bdd_nom_table"] = "Table Name";
$vocab["bdd_nombre_enregistrement"] = "Number of Records";
...
$vocab["calendrier_feries"] = "Holiday calendar";
$vocab["calendrier_jours/cycles"] = "Calendar \"cycle days\"";
$vocab["calendrier_vacances"] = "School holiday calendar";
...
$vocab["captcha_incorrect"] = "Incorrect captcha!";
$vocab["captcha_utiliser"] = "Use the captcha";
$vocab["cas_code_fonction"] = "Function code";
$vocab["cas_fonctionnalite_mail_actif"] = "In case the mail/SMTP function is activated.";
$vocab["cas_language"] = "Language";
$vocab["cas_libelle_fonction"] = "Function Label";
...
$vocab["config_cas_attributs"] = "CAS attributes to retrieve and match with the fields in the GRR database (for the CAS service to be operational, it is also necessary to configure your CAS server):";
...
$vocab["crea_compte_inscrivez"] = "Sign up";
...
$vocab["del_group_succeed"] = "The group has been successfully removed.";
...
$vocab["deleteseriesposterieure"] = "Delete all associated reservations made after this date";
...
$vocab["display_menu_1"] = "Menu display (calendar, domains, and resources)";
...
$vocab["display_type_order_identifiant"] = "Sort by identifier";
$vocab["display_type_order_nom"] = "Sort by name";
...
$vocab["drag_drop"] = "Drag and drop reservations";
...
$vocab["email_beneficiaire"] = "Recipient's email";
$vocab["Email_expediteur_messages_automatiques"] = "Email sender of the automatic e-mails";
$vocab["Email_pour_la_reponse"] = "Your email address";
$vocab["en"] = "to";
...
$vocab["envoyer_maintenant_mail_retard"] = "Send an email immediately to notify of the delay (failure to return the item on time).";
...
$vocab["erreur_caract_login"] = "The identifier can only contain the following characters: A-Z a-z 0-9 _ @ . - (Spaces are not allowed)";
...
$vocab["est_prevenu_par_mail"] = "This user is automatically notified by email for the following resource(s):";
$vocab["et"] = "and";
...
$vocab["execution_automatique_backup_explications"] = "An automatic backup can be triggered by the execution of the script \"admin_save_mysql.php\", for example, by scheduling its execution using a \"cron\" task. To enable this feature, you must define a password below. For example, if the password is jamesbond007, the URL of the type: http://my-site.com/grr/admin_save_mysql.php?password=jamesbond007 will trigger the backup. It is strongly recommended to choose a complex password with letters, numbers, and special characters!";
...
$vocab["explain_horaire_autorise"] = "You can restrict the connection to GRR between certain times. Leave blank to not restrict the connection to times or enter the allowed time range (HH:MM format). Administrators are not impacted by this restriction.";
...
$vocab["format_identifiant_incorrect"] = "The identifier contains unauthorized characters.";
...
$vocab["gestionnaire_des_ressources_suivantes"] = "Manager of the following resource(s):";
...
$vocab["groupe_add"] = "Add a group";
$vocab["groupe_exist"] = "A group already exists with this name!";
$vocab["groupe_modifier"] = "Edit a group";
...
$vocab["index_msg3"] = "Error connecting to the $dbsys server. The file \"connect.inc.php\" may not contain the correct connection information.";
...
$vocab["langue_de-de"] = "German";
$vocab["langue_en-gb"] = "English";
$vocab["langue_es-es"] = "Spanish";
$vocab["langue_fr-fr"] = "French";
$vocab["langue_it-it"] = "Italian";
...
$vocab["log_mail"] = "Email sending log since the ";
...
$vocab["mail_desc_admin_test"] = "Test email sent from the GRR administration.";
$vocab["mail_desc_compte_creation"] = "Email to the applicant and user manager(s) upon request for account creation.";
$vocab["mail_desc_compte_decision1"] = "Email to the beneficiary for a positive response to the request.";
$vocab["mail_desc_compte_decision2"] = "Email to the beneficiary for a negative response to the request.";
$vocab["mail_desc_dest_adm"] = "Email for individuals notified via the administration and/or an additional field.";
$vocab["mail_desc_dest_beneficiaire"] = "Email to the reservation beneficiary.";
$vocab["mail_desc_dest_gestionnaire"] = "Email to the resource manager";
$vocab["mail_desc_dest_supauto"] = "Automatic deletion email for the beneficiary and individuals notified via the administration and/or an additional field.";$vocab["mail_message"] = "Message";
...
$vocab["mail_raison_4"] = "You are receiving this email because you are the administrator and no manager is defined with an email address.";
$vocab["mail_raison_5"] = "You are receiving this email because your email address is entered in an additional field or by the administrator.";
$vocab["mail_raison_6"] = "You are receiving this email because you are the reservation recipient.";
...
$vocab["mail_test"] = "Test Email";
$vocab["mail_type_adm_test"] = "Test";
$vocab["mail_type_compte_demande"] = "Account Request";
$vocab["mail_type_resa_creation"] = "Reservation Creation";
$vocab["mail_type_resa_moderation"] = "Reservation & Moderation";
$vocab["mail_type_resa_moderation_decision"] = "Moderation Decision";
$vocab["mail_type_resa_modif"] = "Reservation Modification";
$vocab["mail_type_resa_resultat"] = "Result";
$vocab["mail_type_resa_retard"] = "Delay";
$vocab["mail_type_resa_sup"] = "Reservation Cancellation";
$vocab["mail_type_resa_sup_auto"] = "Automatic Reservation Cancellation";
...
$vocab["mail_user_obligatoire"] = "An email address is required in the user account.";
$vocab["mail_user_unique"] = "The email address must be unique.";
$vocab["mail_user_unique_error"] = "The email address is already in use.";
$vocab["mail_user_unique_error_admin"] = "One or more email addresses are duplicated, please correct them.";
...
$vocab["maj_recherche_desactive"] = "The update search is disabled.";
...
$vocab["max_resa_affiche"] = "Maximum number of reservations to display";
$vocab["max_resa_affiche_explain"] = "Beyond this number in certain planning views, \"...\" will be displayed.";
$vocab["mdp_taille"] = "The password length must be equal to or greater than";
...
$vocab["Message_poste_par"] = "Message posted by";
...
$vocab["methode_mail_bloque"] = "Email sending is disabled";
$vocab["methode_mail_desactive"] = "The \"mail\" method is disabled on the server, please use the SMTP method";
...
$vocab["modification_parametre_affichage"] = "Users authorized to modify their display";
$vocab["modification_parametre_domaine"] = "Users authorized to modify their default domain and resource";
$vocab["modification_parametre_email"] = "Users authorized to modify their e-mail address";
$vocab["modification_parametre_langue"] = "Users authorized to change their language";
$vocab["modification_parametre_theme"] = "Users authorized to change their theme";
...
$vocab["modifier_site"] = "Edit a site";
...
$vocab["Module_Int_Gestion"] = "Internal module management";
...
$vocab["ne_contient_pas"] = "does not contain";
$vocab["Ne_pas_activer_Service_sso"] = "Don't activate the consideration of a SSO";
$vocab["necessite_fonction_mail_automatique"] = "requires that the automatic email sending function be activated and that the borrower's \"email\" field be filled in.";
...
$vocab["noreservation"] = "The requested reservation does not exist. It's likely to be deleted.";
...
$vocab["not_php"] = " WARNING: This application may not function correctly with versions prior to PHP7. ";
...
$vocab["Objet_du_message"] = "Subject of the message";
$vocab["of"] = " on ";
...
$vocab["pass_change_conditions"] = "If any of the rules are not followed, the user must change their password.";
$vocab["pass_faciles"] = "Ban simple passwords.";
$vocab["pass_leng_error"] = "The minimum password length is too short according to the criteria!";
$vocab["pass_leng_explain"] = "Minimal length of the password";
$vocab["pass_leng_save_err"] = "Error saving pass_leng !";
$vocab["pass_nb_ch"] = "Minimum number of digits";
$vocab["pass_nb_maj"] = "Minimum number of uppercase letters";
$vocab["pass_nb_min"] = "Minimum number of lowercase letters";
$vocab["pass_nb_sp"] = "Minimum number of special characters";
$vocab["pass_x_ch"] = "digit";
$vocab["pass_x_chs"] = "digits";
$vocab["pass_x_maj"] = "uppercase";
$vocab["pass_x_majs"] = "uppercase";
$vocab["pass_x_min"] = "lowercase";
$vocab["pass_x_mins"] = "lowercase";
$vocab["pass_x_sp"] = "special character";
$vocab["pass_x_sps"] = "special characters";
$vocab["passwd_error"] = "An error occurred when entering password, please retry!";
...
$vocab["please_go_to_admin_maj"] = "It is strongly recommended that you update your database by going to the MANAGEMENT section.";
...
$vocab["pwd_too_short"] = "Password (".$pass_leng." characters minimum)";
...
$vocab["Redigez_votre_message_ci_dessous"] = "Write your message below";
...
$vocab["remplissage_description_complete1"] = "The filling of the field \"full description\" is compulsory";
$vocab["remplissage_description_complete2"] = "The \"full description\" section is hidden.";
...
$vocab["reservation_confirmee"] = "Reservation confirmed";
...
$vocab["reservations_et_logs"] = "Reservations & reservation logs";
$vocab["reservations_moderees"] = "Moderated reservations";
$vocab["reservations deleted"] = "Reservations deleted";
$vocab["reserved_in_the_name_of"] = "Reservation in the name of ";
$vocab["reserve"] = "Reserve";
...
$vocab["ressource_ou_domaine_non_defini"] = "Resource or domain not defined";
...
$vocab["search_report_stats"] = "Research - Reports - Statistics";
...
$vocab["site"] = "site";
$vocab["site_access"] = "Restricted access";
...
$vocab["smtp_allow_self_signed"] = "Allows self-signed certificates (Default: false)";
$vocab["smtp_auth"] = "SMTP Authentication (SMTP-AUTH)";
$vocab["smtp_param_sup"] = "Below are additional settings that are reserved for advanced users.";
...
$vocab["smtp_verify_depth"] = "String depth (Default 3)";
$vocab["smtp_verify_peer"] = "Peer name verification (Default true)";
$vocab["smtp_verify_peer_name"] = "SSL certificate verification (Default true)";
$vocab["SSL"] = "Use SSL";
...
$vocab["supprimer_avant_date"] = "Delete before a date";
...
$vocab["supprimer_tout"] = "Delete the set";
...
$vocab["title_horaire_autorise"] = "Connection time";
...
$vocab["type_color_icone"] = "Choice of icon color in hexadecimal";
...
$vocab["type_resa_manquant_msg"] = "One or more types are currently used in reservations but are not listed in the types table. This may cause error messages. You must therefore define the missing type(s) below. These are the following types: ";
$vocab["type_resa_manquant_titre"] = "WARNING: Your reservation types table is not up to date!";
$vocab["type_resa_vide_msg"] = "At least one reservation has a missing type. You should check and correct your reservations table.";
...
$vocab["user_book_room_list"] = "Users authorized to book this resource";
...
$vocab["user_site_list"] = "List of people with access to this site (excluding administrators):";
...
$vocab["valide_au_moins_une_des_conditions_suivantes"] = "Validates at least one of the following conditions";
$vocab["valide_toutes_les_conditions_suivantes"] = "Validates all the following conditions";
$vocab["valide_toutes_moderation"] = "Validate all reservations awaiting moderation";
...
$vocab["wrong_pwd2"] = "An error occurred when entering password, please retry!";
