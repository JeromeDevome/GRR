...
CREATE TABLE grr_type_area (id int(11) NOT NULL auto_increment, type_name varchar(30) NOT NULL default '',order_display smallint(6) NOT NULL default '0',couleur smallint(6) NOT NULL default '0',couleurhexa varchar(10) NOT NULL,type_letter char(2) NOT NULL default '',disponible VARCHAR(1) NOT NULL DEFAULT '2', couleurtexte varchar(10) NOT NULL default '#000000', PRIMARY KEY  (id));
