...
CREATE TABLE grr_participants (idresa int(11) NOT NULL, participant varchar(150) NOT NULL, PRIMARY KEY (idresa,participant));
...
INSERT INTO grr_setting VALUES ('version', '3.4.4');
