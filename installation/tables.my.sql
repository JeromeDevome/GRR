...
CREATE TABLE grr_utilisateurs (login varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL default '', nom varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL default '', prenom varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL default '', password varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL default '', changepwd tinyint(1) NOT NULL DEFAULT '0', email varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL default '', statut varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL default '', etat varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL default '', default_site smallint(6) NOT NULL default '0', default_area smallint(6) NOT NULL default '0', default_room smallint(6) NOT NULL default '0', default_style varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL default '', default_list_type varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL default '', default_language char(3) NOT NULL default '', source varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL default 'local', PRIMARY KEY  (login) );
