...
CREATE TABLE grr_room (  `id` int(11) NOT NULL auto_increment,  `area_id` int(11) NOT NULL DEFAULT 0,  `room_name` varchar(60) NOT NULL DEFAULT '',  `description` varchar(60) NOT NULL,  `capacity` int(11) NOT NULL DEFAULT 0,  `max_booking` smallint(6) NOT NULL DEFAULT -1,  `statut_room` char(1) NOT NULL DEFAULT '1',  `show_fic_room` char(1) NOT NULL DEFAULT 'n',  `picture_room` varchar(50) NOT NULL DEFAULT '',  `comment_room` text NOT NULL,  `show_comment` char(1) NOT NULL DEFAULT 'n',  `delais_max_resa_room` smallint(6) NOT NULL DEFAULT -1,  `delais_min_resa_room` smallint(6) NOT NULL DEFAULT 0,  `allow_action_in_past` char(1) NOT NULL DEFAULT 'n',  `dont_allow_modify` char(1) NOT NULL DEFAULT 'n',  `order_display` smallint(6) NOT NULL DEFAULT 0,  `delais_option_reservation` smallint(6) NOT NULL DEFAULT 0,  `type_affichage_reser` smallint(6) NOT NULL DEFAULT 0,  `moderate` tinyint(1) DEFAULT 0,  `qui_peut_reserver_pour` char(1) NOT NULL DEFAULT '5',  `active_ressource_empruntee` char(1) NOT NULL DEFAULT 'y',  `active_cle` char(1) NOT NULL DEFAULT 'y',  `active_participant` tinyint(1) NOT NULL DEFAULT 0,  `who_can_see` smallint(6) NOT NULL DEFAULT 0,  `booking_range` smallint(6) NOT NULL DEFAULT -1,  `who_can_book` tinyint(1) NOT NULL DEFAULT 1, PRIMARY KEY  (id))
DROP TABLE IF EXISTS grr_utilisateurs;
CREATE TABLE grr_utilisateurs (login varchar(40) NOT NULL default '', nom varchar(30) NOT NULL default '', prenom varchar(30) NOT NULL default '', password varchar(200) NOT NULL default '', changepwd tinyint(1) NOT NULL DEFAULT '0', email varchar(100) NOT NULL default '', statut varchar(30) NOT NULL default '', etat varchar(20) NOT NULL default '', default_site smallint(6) NOT NULL default '0', default_area smallint(6) NOT NULL default '0', default_room smallint(6) NOT NULL default '0', default_style varchar(50) NOT NULL default '', default_list_type varchar(50) NOT NULL default '', default_language char(3) NOT NULL default '', source varchar(10) NOT NULL default 'local', PRIMARY KEY  (login) );
...
CREATE TABLE grr_groupes (`idgroupes` int(11) NOT NULL AUTO_INCREMENT, `nom` varchar(120) NOT NULL, description text NOT NULL, `archive` tinyint(1) NOT NULL DEFAULT '0', PRIMARY KEY (`idgroupes`));
DROP TABLE IF EXISTS grr_utilisateurs_groupes;
CREATE TABLE grr_utilisateurs_groupes (`idutilisateursgroupes` bigint(20) NOT NULL AUTO_INCREMENT, `login` varchar(40) NOT NULL, `idgroupes` int(11) NOT NULL, PRIMARY KEY (`idutilisateursgroupes`), UNIQUE KEY `idutilisateurs` (`login`,`idgroupes`));
...
INSERT INTO grr_setting VALUES ('begin_bookings', '1577836800');
...
INSERT INTO grr_setting VALUES ('display_type', '1');
INSERT INTO grr_setting VALUES ('end_bookings', '1672441200');
...
INSERT INTO grr_setting VALUES ('version', '4.0.0a');
