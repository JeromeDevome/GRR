...
CREATE TABLE grr_utilisateurs (login varchar(190) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL default '', nom varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL default '', prenom varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL default '', password varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL default '', changepwd tinyint(1) NOT NULL DEFAULT '0', email varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL default '', statut varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL default '', etat varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL default '', default_site smallint(6) NOT NULL default '0', default_area smallint(6) NOT NULL default '0', default_room smallint(6) NOT NULL default '0', default_style varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL default '', default_list_type varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL default '', default_language char(3) NOT NULL default '', source varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL default 'local', PRIMARY KEY  (login) );
...
CREATE TABLE grr_entry_moderate (id int(11) NOT NULL auto_increment, login_moderateur varchar(190) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL default '',motivation_moderation text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,start_time int(11) NOT NULL default '0',end_time int(11) NOT NULL default '0',entry_type int(11) NOT NULL default '0', repeat_id int(11) NOT NULL default '0',room_id int(11) NOT NULL default '1',timestamp timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, create_by varchar(190) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL default '', beneficiaire_ext varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL default '', beneficiaire varchar(190) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL default '', name varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL default '',type char(2) default NULL,description text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,statut_entry char(1) NOT NULL default '-',option_reservation int(11) NOT NULL default '0',overload_desc text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci, moderate tinyint(1) default '0', PRIMARY KEY  (id), KEY idxStartTime (start_time), KEY idxEndTime (end_time));
