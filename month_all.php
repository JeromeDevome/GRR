 ...
 * Dernière modification : $Date: 2024-08-19 10:34$
...
else  //Build an array of information about each day in the month.
{
	...
	for ($i = 0; ($row = grr_sql_row($res, $i)); $i++)
	{
        ...
        {
            $verif_acces_ressource[$row[5]] = verif_acces_ressource($user_name, $row[17]); 
            $acces_fiche_reservation[$row[5]] = verif_acces_fiche_reservation($user_name, $row[17]);
