 ...
 * Dernière modification : $Date: 2024-10-17 11:21$
...
{
  $first_slot = (int)($morningstarts * 3600 / $this_area_resolution); 
  $last_slot = (int)(($eveningends * 3600 + $eveningends_minutes * 60) / $this_area_resolution) -1; 
}
if ($debug_flag){
...
// Pour toutes les réservations
  foreach($res as $row) 
  {
    ...
    if ($enable_periods != 'y') // cas des plages définies par horaires
    {
      ...
      $slot = (int)(($t - $day_midnight) % 86400 / $this_area_resolution); // premier slot à afficher
