...
else
{
	if (isset($id) && ($id != 0))
	{
		jQuery_TimePicker('start_', $start_hour, $start_min,$duree_sec,$resolution,$morningstarts,$eveningends,$eveningends_minutes,$twentyfourhour_format);
	}
	else
	{
		jQuery_TimePicker('start_', '', '',$duree_par_defaut_reservation_area,$resolution,$morningstarts,$eveningends,$eveningends_minutes,$twentyfourhour_format);
	}
}
...
else // sélection de l'heure ou du créneau de fin
{
	...
	else
	{
		if (isset($id) && ($id != 0))
		{
			jQuery_TimePicker('end_', $end_hour, $end_min,$duree_sec,$resolution,$morningstarts,$eveningends,$eveningends_minutes,$twentyfourhour_format);
		}
		else
		{
			jQuery_TimePicker('end_', '', '',$duree_par_defaut_reservation_area,$resolution,$morningstarts,$eveningends,$eveningends_minutes,$twentyfourhour_format);
		}
	}
