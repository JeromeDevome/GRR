    ...
    public static function DocumentResa($idResa)
	{
        ...
        for ($i = 0; $i < $nb; $i++) {
            ...
            if (rename($uploadDir.$origName, $uploadDir.$fileName)) {
                ...
                $req = "INSERT INTO ".TABLE_PREFIX."_files (id_entry, file_name, public_name) VALUES ($idResa,'".SecuChaine::protect_data_sql($fileName)."','".SecuChaine::protect_data_sql(substr($origName, 0, 50))."')";
