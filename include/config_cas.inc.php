...
*/
 $user_nom = recuperer_nom(phpCAS::getAttribute(Settings::get("cas_nom")));
 $user_prenom = recuperer_prenom(phpCAS::getAttribute(Settings::get("cas_prenom")));
 $user_language = recuperer_language(phpCAS::getAttribute(Settings::get("cas_language")));
 $user_code_fonction = recuperer_code_fonction(phpCAS::getAttribute(Settings::get("cas_code_fonction")));
 $user_libelle_fonction = recuperer_libelle_fonction(phpCAS::getAttribute(Settings::get("cas_libelle_fonction")));
 $user_mail = recuperer_mail(phpCAS::getAttribute(Settings::get("cas_mail")));
