...
function mrbsCheckFree($room_id, $starttime, $endtime, $ignore, $repignore, $link="")
{
	...
	for ($i = 0; ($row = grr_sql_row($res, $i)); $i++)
	{
		...
		$err .= "<li><a href=\"".$link."view_entry.php?id=$row[0]\">".htmlspecialchars($row[1])."</a>"
 ...
 */
function mrbsGetRepeatEntryList($time, $enddate, $rep_type, $rep_opt, $max_ittr, $rep_num_weeks, $rep_jour_c, $area, $rep_month_abs1, $rep_month_abs2, $type_jour=array(0,0))
{
	$sec   = date("s", $time);
	$min   = date("i", $time);
	$hour  = date("G", $time);
 ...
 *   non-zero - The entry's ID
 */
function mrbsCreateRepeatingEntrys($starttime, $endtime, $rep_type, $rep_enddate, $rep_opt, $room_id, $creator, $beneficiaire, $beneficiaire_ext, $name, $type, $description, $rep_num_weeks, $option_reservation,$overload_data, $moderate, $rep_jour_c, $courrier, $nbparticipantmax=0, $rep_month_abs1=0, $rep_month_abs2=0, $ignore=array())
{
 ...
 *   non-zero - The entry's ID
 */
function grrCreateRepeatingEntrys($starttime, $endtime, $rep_type, $rep_enddate, $rep_opt, $room_id, $creator, $beneficiaire, $beneficiaire_ext, $name, $type, $description, $rep_num_weeks, $option_reservation,$overload_data, $moderate, $rep_jour_c, $courrier, $nbparticipantmax=0, $rep_month_abs1=0, $rep_month_abs2=0, $serie=array())
{
