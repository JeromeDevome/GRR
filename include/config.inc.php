 ...
 * Dernière modification : $Date: 2026-02-25 10:17$
...
# Sécurité cookies de session "None", "Lax" ou "Strict" - Defaut "Strict"
# Peut être nécessaire de mettre "None" si GRR est utilisé dans un contexte de cross-site (ex: GRR intégré dans une iframe sur un autre site), ou "Lax" pour une connexion SSO
$gSameSite = "Strict";
